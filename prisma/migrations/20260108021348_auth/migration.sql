/*
  ...
  - You are about to drop the column `microStep` on the `Session` table. All the data in the column will be lost.
  - You are about to drop the column `response` on the `Session` table. All the data in the column will be lost.
